...
const HowOrder = () => {
  ...
  <div class="accordion">
    <div class="accordion-item">
      <button id="accordion-button-1" aria-expanded="false"><span class="accordion-title">วิธีสั่งสินค้าของทางเรา ไม่ยากอย่างที่คิด?</span><span class="icon" aria-hidden="true"></span></button>
